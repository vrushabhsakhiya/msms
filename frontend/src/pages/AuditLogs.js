                ...
                <div className="table-container shadow-sm">
                    <table className="table">
                        ...
                        <tbody>
                            {(() => {
                                if (loading) {
                                    return <tr><td colSpan="6" style={{ textAlign: "center", padding: "3rem" }}>Loading secure logs...</td></tr>;
                                }
                                if (filteredLogs.length === 0) {
                                    return <tr><td colSpan="6" style={{ textAlign: "center", padding: "3rem" }}>No matching logs found.</td></tr>;
                                }
                                return filteredLogs.map((log) => (
                                    <tr key={log.id}>
                                        ...
                                        <td>
                                            <span style={{ color: "var(--primary)", fontWeight: "600", background: "var(--primary-light)", padding: "2px 8px", borderRadius: "8px", fontSize: "0.8rem" }}>
                                                {log.module_name}
                                            </span>
                                        </td>
                                        <td>
                                            <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
                                                ...
                                                <span style={{ fontWeight: "700", fontSize: "0.75rem" }}>{getActionLabel(log.action_type)}</span>
                                            </div>
                                        </td>
                                        <td>
